...
function Navbar() {
  return (
    <nav className="max-w-[750px] w-full mx-auto p-3 lg:p-1.5 !pl-4 border border-gray-200 bg-gray-50/80 rounded-lg flex justify-between items-center">
      ...
      <div className="flex-1 flex justify-end items-center">
        ...
        <button className="p-2.5 block lg:hidden">
          <MenuIcon />
        </button>
      </div>
    </nav>
